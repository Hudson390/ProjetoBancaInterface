...
public class MenuAlterarRevista extends Banca{


    public MenuAlterarRevista() {
        setTitle("ALTERAR REVISTA ");
        setVisible(true);
        setSize(600,520);
        ...
        editora.setBounds(40, 220, 200, 50 );
        editora.setFont(new Font("Arial", Font.BOLD, 15));
