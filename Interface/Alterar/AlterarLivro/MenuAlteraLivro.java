package Interface.Alterar.AlterarLivro;
...
public class MenuAlteraLivro extends Banca {

    public MenuAlteraLivro() {
        ...
        text5.setBounds(40,370, 500, 50);
        text5.setFont(new Font("Arial", Font.BOLD, 15));

        text6 = new JTextField();
        text6.setBounds(40,470, 500, 50);
